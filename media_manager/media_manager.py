...
class MediaManager:
    ...
    def verify_parent_directory(self):
        ...
        print(f"\tVerifying if Media is Missing Parent Folder: {os.path.normcase(os.path.join(self.directory, ''))} - {os.path.normcase(os.path.join(self.parent_directory, self.folder_name, ''))}")
